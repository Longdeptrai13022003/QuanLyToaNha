...
return [
    ...
    [
        ...
        'headerOptions' => ['width' => '1%'],
        'value' => function ($data) {
            return $data->hoten_sale == null ? '' : $data->hoten_sale.' <i class="fa fa-phone"></i> '.$data->dien_thoai_sale;
        },
        'format'=>'raw',
        'filter' => \yii\helpers\Html::activeTextInput(
...
//    ],
    [
        'header' => 'TT',
        'value' => function($data) {
            return $data->thanh_tien == $data->da_thanh_toan ? '' : \yii\bootstrap\Html::a('<i class="fa fa-money"></i>',Url::toRoute(['phong-khach/thanh-toan', 'id' => $data->id]), ['class' => 'text-success', 'role' => 'modal-remote', 'data-toggle' => 'tooltip','id'=>'btn-purchase']);
        },
        'format' => 'raw',
        'filter' => Html::activeDropDownList(
            $searchModel,
    ...
    [
        'header' => 'Gia hạn',
        'value' => function($data) {
            return \yii\bootstrap\Html::a('<i class="fa fa-refresh"></i>','#', ['class' => 'text-warning btn-gia-han','data-value'=>$data->id]);
        },
        'format' => 'raw',
        'headerOptions' => ['width' => '1%', 'class' => 'text-center'],
        'contentOptions' => ['class' => 'text-center']
